...
// the Theme's Flavor, produce the application's effect, and reload
...
// theme directory, i.e. the theme does not carry an effect for that
...
// application. Run renders the recipe's template against t.Flavor, produces
// the application's effect, and reloads the application; an error indicates
// any step failed. Orchestrators run recipes independently and aggregate
// errors.
